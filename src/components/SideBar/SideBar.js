...
export function SideBar({ accountType, onMenuSelect, selectedMenuItem }) {
  ...
  switch (accountType) {
    case "teller":
      menuItems = ["My Profile", "Customer Accounts", "Customer Cards", "Pending Transactions", "Pending Transfers"];
      break;
    case "auditor":
    ...
    case "user":
    default:
      menuItems = ["My Profile", "Accounts", "Transaction History", "Make a Transaction", "Transfer History", "Make a Transfer"];
      break;
  }
  return (
    <Card
